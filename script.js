...
// Далее - НЕобязательный функционал для <появления-пропадания> изображения

let buttonFour=document.getElementById("four");
let buttonThirtyTwo=document.getElementById("thirty-two");
let buttonFiveHundredTwelve=document.getElementById("five-hundred-twelve");

buttonFour.addEventListener ("click", () => { toggler(pixel) })
buttonThirtyTwo.addEventListener ("click", () => { toggler(pixel) })
buttonFiveHundredTwelve.addEventListener ("click", () => { toggler(pixel) })
